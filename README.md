...
Road Architect works with Unity 2017 and 2018. If interested in contributing please open an issue or pull request.

- Currently, I recommend downloading the main git repository: `git clone https://github.com/embeddedt/RoadArchitect.git`  downloading a ZIP from GitHub.
- The resulting folder should be copied to the root of your Assets directory and should be renamed to RoadArchitect.
